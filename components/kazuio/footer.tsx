...
const SOCIALS = [
  ...
  { label: 'Facebook', href: 'https://www.facebook.com/profile.php?id=61593373558468', icon: FacebookIcon },
      ...
      <div className="mx-auto max-w-[1220px] px-5 pb-8 pt-10 md:px-8 md:pt-12">
        <div className="grid gap-10 md:grid-cols-[1.25fr_1fr_1.25fr_0.9fr]">
          <div>
            ...
            <a href="/login" className="mt-5 inline-block text-xs font-semibold text-gold2 hover:text-cream">Começar a conversar →</a>
          </div>
